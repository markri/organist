...
class ApplicationControllerTest extends WebTestCase
{
    ...
    public function testCreateApplication()
    {
        ...
        $crawler = $client->request('GET', $this->getUrl('markri_organist_application_create'));
        ...
        $form['application_create[applicationType]'] = 'organist.type.symfony';
        $form['application_create[scmService]'] = 'organist.versioning.git';
    ...
    public function testEditApplication()
    {
        ...
        $crawler = $client->request('GET', $this->getUrl('markri_organist_application_edit', array('application' => 1)));
    ...
    public function testDeleteApplication()
    {
        ...
        $client = static::createClient();
        $client->request('GET', $this->getUrl('markri_organist_application_delete', array('application' => 1)));
    ...
    public function testCheckoutRepository()
    {
        ...
        $crawler = $client->request('GET', $this->getUrl('markri_organist_application_checkoutrepository', array('application' => 1)));;
         ...
         */
        $commandLog = $this->getContainer()->get('doctrine.orm.entity_manager')->getRepository('OrganistBundle:CommandLog')->findOneById(1);
...
//            }
    ...
    /**
     * @depends Markri\Bundle\OrganistBundle\Tests\Controller\ApplicationControllerTest::testCheckoutRepository
    ...
    public function testUpdateRepository()
    {
        ...
        $client = static::createClient();
        $client->request('GET', $this->getUrl('markri_organist_application_updaterepository', array('application' => 1)));
    ...
    public static function tearDownAfterClass()
    {
        ...
        $path = $kernel->getContainer()->getParameter('organist.repositorypath').'/testkey';
