$(function () {
    ...
    $(document).ready(function() {
        ...
        // ****************** Load changeset
        //$("#markri_organistbundle_applicationdeploy_target").change(
        //    function(){
        //        loadChangeList();
        //    }
        //);
        //
        //$("#markri_organistbundle_applicationdeploy_revision").change(
        //    function(){
        //        loadChangeList();
        //    }
        //);
        ...
        //    var target = $("#markri_organistbundle_applicationdeploy_target").val();
        //    var revision = $("#markri_organistbundle_applicationdeploy_revision").val();
        //
        //    if(!target || !revision){
        //        return;
        //    }
        ...
        //        app_dev = '/app_dev.php'
        //    }
        //    $('#loadchangeset').html('<div class="col-lg-2"></div><div class="col-lg-10"><img src="/bundles/organist/img/ajax-loader.gif"> Loading changeset</div>')
        //
        //    $.ajax({
