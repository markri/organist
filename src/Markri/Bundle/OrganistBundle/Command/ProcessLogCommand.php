...
class ProcessLogCommand extends ContainerAwareCommand
{
     ...
     protected function execute(InputInterface $input, OutputInterface $output)
     {
         ...
         foreach($ids as $i=>$id){
             ...
             /**
              * @var \Markri\Bundle\OrganistBundle\Entity\CommandLog $commandLog
              */
             $commandLog = $em->getRepository('OrganistBundle:CommandLog')->find($id);
             ...
             /**
              * @var \Markri\Bundle\OrganistBundle\Entity\Target $target
              */
