...
//        });
        ...
        // ******************** Vhost aliases
        // Get the ul that holds the collection of tags
        var collectionHolder = $('div.domainaliases');

        // setup an "add a tag" link
        var $addAliasLink = $('<div class="col-lg-10"><a id="addaliasbutton" href="#">Add another domain alias</a></div>');
        var $newLink = $('<div><div class="col-lg-2"></div></div>').append($addAliasLink);
        ...
        $addAliasLink.on('click', function(e) {
            // prevent the link from creating a "#" on the URL
            e.preventDefault();
            ...
            // add a delete link to the new form
            addAliasDeleteLink($newFormDiv);

            $newLink.before($newFormDiv);
        });


        function addAliasDeleteLink($formDiv) {
            var $removeFormA = $('<div class="col-lg-1"><label></label><a href="#" class="btn btn-danger">delete</a></div>');
            $formDiv.append($removeFormA);
